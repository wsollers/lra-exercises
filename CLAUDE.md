...
Canonical overlay: capabilities/overlays/lra-exercises.md
...
Repository: `lra-exercises`
Canonical repo overlay: `capabilities/overlays/lra-exercises.md`
Canonical route resolver:
`python <governance-root>/scripts/govpy.py capabilities/resolve.py --repo lra-exercises --task "<user task>" --root <repo-root>`
